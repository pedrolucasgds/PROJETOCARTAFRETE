...
function calculateDifference() {
    ...
    const adjustedDiff = weightDiff - toleranceInKg > 0 ? weightDiff - toleranceInKg : 0;
    ...
    const result = `
        ...
        Diferença ajustada: ${adjustedDiff.toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} kg<br>
